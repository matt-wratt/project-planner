...
import { Button, ButtonGroup, DropdownButton, Glyphicon, Input, Nav, Navbar, NavItem, MenuItem } from 'react-bootstrap'
...
export default class App extends React.Component {
  ...
  renderProjectItem(project, i) {
    ...
    return (
      <MenuItem eventKey={ i } className={ active }>{ project.name }</MenuItem>
    )
  }
